...
if __name__ == "__main__":
    directory_path_th0 = r"C:\Users\gaeta\OneDrive\Desktop\Projet_IA\HumanFinder2000\data\images_th0"  # Replace with the actual directory path

    image_names_th0 = get_image_names(directory_path_th0)

    directory_path_th1 = r"C:\Users\gaeta\OneDrive\Desktop\Projet_IA\HumanFinder2000\data\images_th1"  # Replace with the actual directory path

    image_names_th1 = get_image_names(directory_path_th1)

    directory_path_depth = r"C:\Users\gaeta\OneDrive\Desktop\Projet_IA\HumanFinder2000\data\images_depth"  # Replace with the actual directory path

    image_names_depth = get_image_names(directory_path_th0)

    directory_path_rgb = r"C:\Users\gaeta\OneDrive\Desktop\Projet_IA\HumanFinder2000\data\images_rgb"
